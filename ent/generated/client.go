...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Update.Intercept(interceptors...)
...
// UpdateOne returns an update builder for the given entity.
func (c *UpdateClient) UpdateOne(_m *Update) *UpdateUpdateOne {
	mutation := newUpdateMutation(c.config, OpUpdateOne, withUpdate(_m))
	return &UpdateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *UpdateClient) UpdateOneID(id string) *UpdateUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity.
func (c *UpdateClient) DeleteOne(_m *Update) *UpdateDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *UpdateClient) DeleteOneID(id string) *UpdateDeleteOne {
...
func (c *UpdateClient) Get(ctx context.Context, id string) (*Update, error) {
	return c.Query().Where(update.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UpdateClient) GetX(ctx context.Context, id string) *Update {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *UpdateClient) mutate(ctx context.Context, m *UpdateMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("generated: unknown Update mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Status, Update, User []ent.Hook
	}
	inters struct {
		Status, Update, User []ent.Interceptor
	}
)
