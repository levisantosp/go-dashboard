...
func (_q *UpdateQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UpdateQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UpdateQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UpdateQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UpdateQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UpdateQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UpdateQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(update.Table, update.Columns, sqlgraph.NewFieldSpec(update.FieldID, field.TypeString))
	_spec.From = _q.sql
