...
type StatusFunc func(context.Context, *generated.StatusMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f StatusFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.StatusMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.StatusMutation", m)
}

// The UpdateFunc type is an adapter to allow the use of ordinary
// function as Update mutator.
type UpdateFunc func(context.Context, *generated.UpdateMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UpdateFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UpdateMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UpdateMutation", m)
}
